<?php
ob_start(); //Output Buffring Start Ma2ilo Lazmi
  session_start();
   if (isset($_SESSION['Username'])){
    ...
    include 'init.php';
    //Start Dashboard page (Home)
    $numUsers = 5; //Numbure Of Latest Usere
    $latestUsers=getLatest("*","users","UserID",$numUsers);  // Latest User Array
    $numItems=5; //Numbure Of Latest Items
    $latestItems=getLatest("*","item","ItemID",$numItems);   //Latest items Array
    $numcomments= 4 ;//Numbure Of Latest comments
    ?>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="stat st-items">
                  ...
                  Total Items
                <span>
                  <a href="items.php"><?php echo countItems('ItemID','item') ?></a>
                </span>
                  </div>
                </div>
              </div>
                        ...
                        <ul class="list-unstyled latest-users">
                              ...
                              foreach($latestUsers as $user){
                               ...
                               ' <a href="members.php?do=Edit&userid='.$user['UserID'].'">
                                ...
                                if($user['RegStatus']==0){
                                  echo "<a href='members.php?do=Activate&userid=".$user['UserID']."' class='btn btn-info pull-right activate'><i class='fa fa-check'></i>Activat</a>";
                                 }
                               echo' </span></a></li>';
                              }
                            }else{
                      ...
                      <div class="panel-body">
                         <?php 
                            ...
                            comments
                              ...
                              INNER JOIN users
                              ON users.UserID= comments.user_id ORDER BY c_id DESC
                              LIMIT $numcomments ");
